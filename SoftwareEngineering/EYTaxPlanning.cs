...
{
    public partial class EYTaxPlanning : Form
    {
        private string vendorInformation = "";
        public EYTaxPlanning()
        {
            InitializeComponent();
        }
        ...
        private void linkLabel3_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            string url = "https://www.ey.com/en_uk/tax";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            vendorInformation = "Vendor Name: EY Tax Planning\n" +
                               "Contact Email: info@ey.com\n" +
                               "Contact Number: 1-800-555-5563\n";
            ...
            string tempHtmlFile = Path.Combine(Path.GetTempPath(), "VendorInformation_EY.html");
